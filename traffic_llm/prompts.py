...
def build_supervisor_system_prompt(allowed: tuple[str, ...]) -> str:
    ...
    return (
        ...
        "Your PRIMARY lever is signal tuning — prefer it over rerouting:\n"
        "  - bias_phase to favor the corridor carrying hotspot-bound demand at the "
        "few intersections feeding a hotspot (this is usually the best move);\n"
        ...
        "Use rerouting SPARINGLY and only for an actual closure or a clearly "
        "jammed segment with a free alternative. Each advisory restricts the whole "
        "network and decays after a while; blanket or repeated advisories push cars "
        "onto longer detours and HURT throughput. When in doubt, do not reroute.\n\n"
